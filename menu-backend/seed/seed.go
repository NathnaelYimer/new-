...
func seedAssignments(ctx context.Context, collection *mongo.Collection) {
	assignments := []models.ProductAssignment{
		{
			...
			Price: 5058.77,
			Visible: true,
			Products: []models.AssignedProduct{
				{Name: "Extended Warranty", Price: 613.16},
				{Name: "Rust Proofing", Price: 617.94},
				{Name: "Paint Protection", Price: 608.39},
				{Name: "Fabric/Leather Protection", Price: 261.84},
				{Name: "Key Fob Replacement", Price: 871.21},
				{Name: "GAP", Price: 990.27},
				{Name: "Scratch/Dent Repair", Price: 1095.96},
			},
		},
		{
			Level: "gold",
	...
	if err != nil {
		...
		log.Println("✅ Assignments seeded with price totals.")
	}
}
